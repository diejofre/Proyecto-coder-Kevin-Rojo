    ...
    <footer className={`w-full ${darkMode ? "bg-dark-blue" : "bg-white"}`}>
      <hr
        className={`w-full bg-light-gray ${
          darkMode ? "text-gray-text-secondary" : "text-light-gray"
        }`}
      />
      <div
        className={`flex justify-between items-center gap-6 p-6 sm-max:flex-col ${
          darkMode ? "bg-dark-blue text-white" : "bg-white text-dark-gray-text"
        }`}
      >
        <div>Copyright © 2023, All Right Reserved</div>
        <div>
          Powered by: <span className="font-bold">Kevin Rojo</span>
        </div>
        <div className="flex gap-4 justify-center items-center">
          <a rel="noreferrer" href={"#"}>
            <img
              onMouseEnter={changeBlueLinkedin}
              onMouseLeave={changeWhiteLinkedin}
          ...
          <a rel="noreferrer" href={"#"}>
            <img
              onMouseEnter={changeBlueGit}
              onMouseLeave={changeWhiteGit}
